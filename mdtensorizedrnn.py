...
# for TensorizedRNMCell, y = f(x^T W h + b)
# for 2DTensorizedRNMCell, y = f([x1, x2]^T W [h1, h2] + b)
...
# Zig-zag order
class MDTensorizedRNN(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.cell_list = nn.ModuleList(
            [MDTensorizedRNNCell(self.input_size, self.hidden_size, self.device) for _ in range(self.L**2)]
        )

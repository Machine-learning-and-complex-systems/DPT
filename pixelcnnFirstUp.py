...
class PixelCNN(nn.Module):
    ...
    def _log_prob(self, sample, x_hat):
        ...
        # Manual set the first up-spin has logp=0: without setting down-spin prob, because it will not be sampled out
        log_prob[:, 0, 0, 0] = 1 - mask[:, 0, 0, 0]
    ...
    def forward2(self, x):
        ...
        x_hat = self.net(xx)
        # x_hat = x_hat.view(x_hat.shape[0], 1, self.L, self.L) # The previous
